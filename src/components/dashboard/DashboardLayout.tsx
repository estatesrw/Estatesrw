    ...
    switch (primaryRole) {
      ...
      case "admin":
        return [
          ...
          { label: "Vendors", items: [
            { label: "Hotels & Apartments", href: "/dashboard/admin/vendors", icon: <BedDouble className="w-4 h-4" /> },
            { label: "Booking Approvals", href: "/dashboard/admin/bookings", icon: <CalendarCheck className="w-4 h-4" /> },
